...
public class CalendarView extends ViewPager {
    ...
    private void refreshMonthView(int position) {
        Log.d("refreshMonthView","refreshMonthView->"+lastClickDate[0]+"+++++"+position);
        ...
        if (mAttrsBean.getChooseType() == 1) {//多选
            ...
            boolean flag = (!mAttrsBean.isSwitchChoose() && lastClickDate[0] == position)
                    || (mAttrsBean.isSwitchChoose()&& lastClickDate[0] == position);
    ...
    public void setLastClickDay(int day) {
        Log.d("setLastClickDay","setLastClickDay->"+currentPosition);
        lastClickDate[0] = currentPosition;
        lastClickDate[1] = day;
    }

    public void setLastClickDay(int day,int type) {//0:上月，1:当月，2:下月
        lastClickDate[0] = type == 0?currentPosition-1:currentPosition+1;
        lastClickDate[1] = day;
    }
